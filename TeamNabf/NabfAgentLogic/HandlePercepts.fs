        ...
        match percept with
            ...
            | JobPercept job -> 
                ...
                | AcceptedJob (jobID, vertexName) ->
                    logError <| sprintf "Added job w. id %A to myjobs. Round is %A" jobID state.SimulationStep
                ...
                | FiredFrom jobID -> 
                    logError <| sprintf "Fired from job w. id %A. Round is %A" jobID state.SimulationStep
